...
function setReasoningEventHandlers() {
    ...
    chatContainer.on('click', '.mes_reasoning_details', function (e) {
        if (!e.target.closest('.mes_reasoning_actions') && !e.target.closest('.mes_reasoning_header')) {
            e.preventDefault();
        }
    });

    chatContainer.on('click', '.mes_reasoning_header', function (e) {
    ...
    chatContainer.on('click', '.mes_reasoning_copy', (e) => {
        e.stopPropagation();
        e.preventDefault();
    });

    chatContainer.on('click', '.mes_reasoning_edit', function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    chatContainer.on('click', '.mes_reasoning_close_all', function (e) {
        e.stopPropagation();
        e.preventDefault();

        chatContainer.find('.mes_reasoning_details[open] .mes_reasoning_header').trigger('click');
    });

    chatContainer.on('click', '.mes_reasoning_edit_done', async function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    chatContainer.on('click', '.mes_reasoning_edit_cancel', function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    chatContainer.on('click', '.mes_edit_add_reasoning', async function () {
        const { message, messageBlock } = getMessageFromJquery(this);
        if (!message?.extra) {
            return;
        }
    ...
    chatContainer.on('click', '.mes_reasoning_delete', async function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    chatContainer.on('pointerup', '.mes_reasoning_copy', async function () {
    ...
    chatContainer.on('input', '.reasoning_edit_textarea', function () {

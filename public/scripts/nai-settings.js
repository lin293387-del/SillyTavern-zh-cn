...
defineSaveScheduler('nai-settings', {
    panelId: 'nai-settings',
    triggers: ['input', 'change'],
    strategy: 'raf',
});
const queueNaiSave = createSaveScheduler('nai-settings', () => createPanelSaveScheduler(() => saveSettingsDebounced()));

...
function getAssistantGreeting(character) {
    const defaultGreeting =
        '欢迎来到SillyTavern特供版，本版基于原版（1.13.4）优化与修复若干问题，如你有任何疑问，可以前往上方中间的<div class="drawer-icon fa-solid fa-user-cog fa-fw interactable openIcon" title="用户设置" data-i18n="[title]User Settings" tabindex="0" role="button"></div>按钮，往下滑到底找到“新手教程面板”查看教程（点击小字即可跳转）' +
        '\n***\n' +
        '你想查找角色卡吗？加入新手教程面板里的两个服务器并通过验证后即可开始！';
